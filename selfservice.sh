...
if [[ -e "/usr/local/bin/dialog" ]]; then
    ...
    if [[ "$swiftDialogVersion" == "2.4.2" ]]; then
        ...
        /usr/sbin/installer -pkg "/Library/Addigy/ansible/packages/Addigy Migration (Self Service) (2.1)/dialog-2.4.2-4755.pkg" -target /
    fi
else
...
MDMLink="$MDMLink"
csvPath="/Library/Addigy/ansible/packages/Addigy Migration (Self Service) (2.1)/abm_devices.csv" # Export device list from ABM for devices expected to migrate
logoPath="/Library/Addigy/ansible/packages/Addigy Migration (Self Service) (2.1)/CoreLogoTransparent.png" # Core logo
...
sdTitleFontSize="24"
sdTitle="none"
sdIcon="/Library/Addigy/ansible/packages/Addigy Migration (Self Service) (2.1)/CoreLogoTransparent.png"
...
packageFolder="/Library/Addigy/ansible/packages/Addigy Migration (Self Service) (2.1)"
